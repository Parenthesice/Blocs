			...
			timer = new TimerTask() {
				...
				public void run() {
					runOnUiThread(new Runnable() {
						@Override
						public void run() {
							ActivityOptionsCompat options5 = ActivityOptionsCompat.makeSceneTransitionAnimation(MainActivity.this, circleimageview1, ViewCompat.getTransitionName(circleimageview1));
							i1.setClass(getApplicationContext(), SplashjoinActivity.class);
							startActivity(i1, options5.toBundle());
							timer.cancel();
						}
					});
				}
